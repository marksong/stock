...
$(function () {
    ...
    //add icons
    $("#ToolTables_crudtable_0").prepend('<i class="icon-plus-sign"/> ');
    $("#ToolTables_crudtable_1").prepend('<i class="icon-edit"/> ');
    $("#ToolTables_crudtable_2").prepend('<i class="icon-remove-sign"/> ');
});