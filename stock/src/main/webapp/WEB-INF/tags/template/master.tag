<%@ tag body-content="scriptless" trimDirectiveWhitespaces="true" isELIgnored="false" %>
...
<body class="">
    ...
    <header class="navbar navbar-inverse navbar-fixed-top" role="banner">
        ...
        <ul class="nav navbar-nav pull-right toolbar">
        	<li class="dropdown">
        		<a href="#" class="dropdown-toggle username" data-toggle="dropdown"><span class="hidden-xs">John McCartney <i class="icon-caret-down icon-scale"></i></span><img src="${ctxStatic}/demo/avatar/dangerfield.png" alt="Dangerfield" /></a>
        		<ul class="dropdown-menu userinfo arrow">
        			<li class="username">
                        <a href="#">
        				    <div class="pull-left"><img class="userimg" src="${ctxStatic}/demo/avatar/dangerfield.png" alt="Jeff Dangerfield" /></div>
    ...
    <div id="page-container">
        ...
        <nav id="page-leftbar" role="navigation">
            ...
            <ul class="acc-menu" id="sidebar">
                ...
                <li><a href="javascript:;"><i class="icon-th"></i> <span>Layout</span> </a>
                    <ul class="acc-menu">
                        <li><a href="layout-grid.html"><span>Grids</span></a>
                        </li><li><a href="layout-horizontal.html"><span>Horizontal Navigation</span></a>
                    </li></ul>
