				...
				<div class="col-sm-12">
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<form id="dataForm" class="form-horizontal" action="${ctx}/admin/product/upload" method="post" enctype="multipart/form-data">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-3 control-label">产品表</label>
									<div class="col-sm-6">
